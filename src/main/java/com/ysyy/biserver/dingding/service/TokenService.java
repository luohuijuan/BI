package com.ysyy.biserver.dingding.service;
...
import com.ysyy.biserver.dingding.config.AppConfig;
import com.ysyy.biserver.dingding.domain.ServiceResult;
import com.ysyy.biserver.dingding.util.FileUtil;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

import static com.ysyy.biserver.dingding.config.UrlConstant.URL_GET_JSTICKET;
import static com.ysyy.biserver.dingding.config.UrlConstant.URL_GET_TOKEN;
...
public class TokenService {
    ...
    public ServiceResult<String> getAccessToken(String appId,String appSecret) {
        // 从持久化存储中读取
        String codeLoginAccessToken = getFromCache("codeLoginAccessToken", "codeLoginAccessToken");
        if (codeLoginAccessToken != null) {
            return ServiceResult.success(codeLoginAccessToken);
        }
        ...
        codeLoginAccessToken = response.getAccessToken();
        putToCache("codeLoginAccessToken", "codeLoginAccessToken", codeLoginAccessToken);
        return ServiceResult.success(codeLoginAccessToken);
    }
