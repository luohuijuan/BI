package com.ysyy.biserver.dingding.controller;
...
import com.ysyy.biserver.dingding.domain.DepartmentDTO;
...
import static com.ysyy.biserver.dingding.config.UrlConstant.URL_DEPARTMENT_LIST;
...
public class ContactController {
    ...
    public ServiceResult<List<DepartmentDTO>> listDepartment(
        ...
        if (!CollectionUtils.isEmpty(response.getDepartment())) {
